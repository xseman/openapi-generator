...
func TestChecksum(t *testing.T) {
	sums := "aaaa  openapi-generator-other\n" +
	...
	if got := checksum(sums, "openapi-generator-nowhere"); got != "" {
...
func FuzzChecksum(f *testing.F) {
	f.Add(strings.Repeat("b", 64)+"  openapi-generator-linux-amd64\n", "openapi-generator-linux-amd64")
	f.Add("  \t\n\n", "x")
...
func TestInstallReplacesTheBinary(t *testing.T) {
	body := []byte(strings.Repeat("openapi-generator!", 5000))
	...
	dest := filepath.Join(t.TempDir(), "openapi-generator")
